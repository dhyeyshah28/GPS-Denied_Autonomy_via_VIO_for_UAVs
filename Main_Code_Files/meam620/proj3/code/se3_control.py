...
class SE3Control(object):
    def __init__(self, quad_params):
        ...
        # Control gains
        #self.kp = np.array([15.5, 15.5, 5.0])  
        #self.kd = np.array([4.5, 5.0, 8.0])  
        #self.kr = np.array([230.0, 230.0, 15.0])  
        #self.kw = np.array([30.0, 50.0, 3.0]) 
        
        #self.kp = np.array([15.5, 15.5, 5.0])
        #self.kd = np.array([4.5, 5.0, 8.0])
        #self.kr = np.array([236.0, 236.0, 8.0])  
        #self.kw = np.array([30.0, 50.0, 4.0]) 

        #self.kr = np.array([250, 250, 8])  # attitude proportional gain
        #self.kw = np.array([200, 200, 6])


        self.kp = np.array([10, 10, 6.0])  
        self.kd = np.array([5, 5, 8.0])  
        self.kr = np.array([220.0, 220.0, 8.0])  
        self.kw = np.array([30.0, 30.0, 4.0]) 
